...
const About = () => (
  <React.Fragment>
    ...
    <ul className="about-list">
      <li><span className="emoji-bullet">🛠️</span>is a software engineer</li>
      <li><span className="emoji-bullet">🇮🇪</span>is from Ireland</li>
      <li><span className="emoji-bullet">🎓</span>lives in London (NW)</li>
      ...
      <li><span className="emoji-bullet">🤔</span>is interested in game design, table top RPGs mostly, also board, card, and computer</li>
    </ul>
  </React.Fragment>
);

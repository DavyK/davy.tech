...
if ("development" !== "production") {
  (function () {
    ...
    if (!ExecutionEnvironment.canUseDOM) {
      var callbackIdCounter = 0; // Timeouts are objects in Node.
      ...
      var safelyCallScheduledCallback = function (callback, callbackId) {
        ...
        try {
          callback(frameDeadlineObject); // Avoid using 'catch' to keep errors easy to debug
        } finally {
      ...
      var callTimedOutCallbacks = function () {
        ...
        var currentTime = now$1(); // TODO: this would be more efficient if deferred callbacks are stored in
        // min heap.
      ...
      var idleTick = function (event) {
        ...
        var currentTime = now$1(); // Next, as long as we have idle time, try calling more callbacks.
    ...
    var validateDOMNesting$1 = validateDOMNesting; // Renderers that don't support persistence
    ...
    var replaceContainerChildren = shim; // Unused
    ...
    function hydrateInstance(instance, type, props, rootContainerInstance, hostContext, internalInstanceHandle) {
      precacheFiberNode$1(internalInstanceHandle, instance); // TODO: Possibly defer this until the commit phase where all the events
      // get attached.
    ...
    function createFiberFromElement(element, mode, expirationTime) {
      ...
      if (typeof type === 'function') {
        ...
        switch (type) {
          ...
          case REACT_TIMEOUT_TYPE:
            fiberTag = TimeoutComponent; // Suspense does not require async, but its children should be strict
            // mode compatible.
    ...
    var ReactFiberInstrumentation_1 = ReactFiberInstrumentation; // TODO: Offscreen updates
    ...
    function updateTimeoutComponent(current, workInProgress, renderExpirationTime) {
      if (enableSuspense) {
        ...
        var prevDidTimeout = workInProgress.memoizedState; // Check if we already attempted to render the normal state. If we did,
    ...
    function updateContextProvider(current, workInProgress, renderExpirationTime) {
      ...
      if (hasContextChanged()) {
        canBailOnProps = false; // Normally we can bail out on props equality but if context has changed
        // we don't do the bailout and we have to reuse existing props instead.
        ...
        case Profiler:
          {
            if (enableProfilerTimer) {
              ...
              onRender(finishedWork.memoizedProps.id, current === null ? 'mount' : 'update', finishedWork.stateNode.duration, finishedWork.treeBaseTime, finishedWork.stateNode.startTime, getCommitTime()); // Reset actualTime after successful commit.
    ...
    function throwException(root, returnFiber, sourceFiber, value, renderIsExpired, renderExpirationTime, currentTimeMs) {
      ...
      if (enableSuspense && value !== null && typeof value === 'object' && typeof value.then === 'function') {
        ...
        var remainingTimeMs = expirationTimeMs - currentTimeMs; // Find the earliest timeout of all the timeouts in the ancestor path.
        ...
        } while (_workInProgress !== null); // Compute the remaining time until the timeout.
        ...
        switch (workInProgress.tag) {
          ...
          case ClassComponent:
            ...
            if ((workInProgress.effectTag & DidCapture) === NoEffect && (typeof ctor.getDerivedStateFromCatch === 'function' && enableGetDerivedStateFromCatch || instance !== null && typeof instance.componentDidCatch === 'function' && !isAlreadyFailedLegacyErrorBoundary(instance))) {
              workInProgress.effectTag |= ShouldCapture; // Schedule the error boundary to re-render using updated state
    ...
    var nextRenderIsExpired = false; // The next fiber with an effect that we're currently committing.
    ...
    function onBlock(remainingExpirationTime) {
      !(nextFlushedRoot !== null) ? invariant(false, 'Should be working on a root. This error is likely caused by a bug in React. Please file an issue.') : void 0; // This root was blocked. Unschedule it until there's another update.
...
},{"./factoryWithTypeCheckers":"node_modules/prop-types/factoryWithTypeCheckers.js"}],"node_modules/gud/index.js":[function(require,module,exports) {
...
module.exports = exports['default'];
},{"react":"node_modules/react/index.js","./implementation":"node_modules/create-react-context/lib/implementation.js"}],"node_modules/react-is/cjs/react-is.development.js":[function(require,module,exports) {
...
},{"./cjs/react-is.development.js":"node_modules/react-is/cjs/react-is.development.js"}],"node_modules/react-router/node_modules/prop-types/lib/ReactPropTypesSecret.js":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react-is":"node_modules/react-is/index.js","./factoryWithTypeCheckers":"node_modules/react-router/node_modules/prop-types/factoryWithTypeCheckers.js"}],"node_modules/tiny-warning/dist/tiny-warning.esm.js":[function(require,module,exports) {
"use strict";
...
function Redirect(_ref) {
  ...
  return _react.default.createElement(context.Consumer, null, function (context$$1) {
    ...
    return _react.default.createElement(Lifecycle, {
      ...
      onUpdate: function onUpdate(self, prevProps) {
        if (!(0, _history.locationsAreEqual)(prevProps.to, location)) {
          method(location);
        }
      },
      to: to
  ...
  var C = function C(props) {
    ...
    return _react.default.createElement(Route, {
      children: function children(routeComponentProps) {
        return _react.default.createElement(Component, (0, _extends2.default)({}, remainingProps, routeComponentProps, {
...
},{"create-react-context":"node_modules/create-react-context/lib/index.js","@babel/runtime/helpers/esm/inheritsLoose":"node_modules/@babel/runtime/helpers/esm/inheritsLoose.js","react":"node_modules/react/index.js","prop-types":"node_modules/react-router/node_modules/prop-types/index.js","tiny-warning":"node_modules/tiny-warning/dist/tiny-warning.esm.js","history":"node_modules/history/esm/history.js","tiny-invariant":"node_modules/tiny-invariant/dist/tiny-invariant.esm.js","path-to-regexp":"node_modules/react-router/node_modules/path-to-regexp/index.js","@babel/runtime/helpers/esm/extends":"node_modules/@babel/runtime/helpers/esm/extends.js","react-is":"node_modules/react-is/index.js","@babel/runtime/helpers/esm/objectWithoutPropertiesLoose":"node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js","hoist-non-react-statics":"node_modules/hoist-non-react-statics/dist/hoist-non-react-statics.cjs.js"}],"node_modules/react-router-dom/node_modules/prop-types/lib/ReactPropTypesSecret.js":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react-is":"node_modules/react-is/index.js","./factoryWithTypeCheckers":"node_modules/react-router-dom/node_modules/prop-types/factoryWithTypeCheckers.js"}],"node_modules/react-router-dom/esm/react-router-dom.js":[function(require,module,exports) {
"use strict";
...
if ("development" !== "production") {
  ...
  NavLink.propTypes = (0, _extends2.default)({}, Link.propTypes, {
    ...
    exact: _reactRouter.Route.propTypes.exact,
    isActive: _propTypes.default.func,
    location: _propTypes.default.object,
    strict: _reactRouter.Route.propTypes.strict,
    style: _propTypes.default.object
  });
}
},{"@babel/runtime/helpers/esm/inheritsLoose":"node_modules/@babel/runtime/helpers/esm/inheritsLoose.js","react":"node_modules/react/index.js","react-router":"node_modules/react-router/esm/react-router.js","history":"node_modules/history/esm/history.js","prop-types":"node_modules/react-router-dom/node_modules/prop-types/index.js","tiny-warning":"node_modules/tiny-warning/dist/tiny-warning.esm.js","@babel/runtime/helpers/esm/extends":"node_modules/@babel/runtime/helpers/esm/extends.js","@babel/runtime/helpers/esm/objectWithoutPropertiesLoose":"node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js","tiny-invariant":"node_modules/tiny-invariant/dist/tiny-invariant.esm.js"}],"static/images/avatar.jpg":[function(require,module,exports) {
module.exports = "/avatar.5df7267b.jpg";
},{}],"src/js/Avatar.js":[function(require,module,exports) {
"use strict";
...
var _avatar = _interopRequireDefault(require("../../static/images/avatar.jpg"));
...
exports.default = _default;
},{"react":"node_modules/react/index.js","../../static/images/avatar.jpg":"static/images/avatar.jpg"}],"src/js/About.js":[function(require,module,exports) {
"use strict";
...
var About = function About() {
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("h2", null, "Davy "), _react.default.createElement("ul", {
    className: "about-list"
  }, _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
  }, "\uD83D\uDEE0\uFE0F"), "is a software engineer"), _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
  }, "\uD83C\uDDEE\uD83C\uDDEA"), "is from Ireland"), _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
  }, "\uD83C\uDF93"), "lives in Oxford"), _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
  }, "\uD83D\uDCBB"), "works at Intercom in London"), _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
    ...
    className: "emoji-bullet"
  }, "\uD83D\uDC09"), "can't resist a good fantasy novel"), _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
  }, "\u270D\uFE0F"), "likes to write"), _react.default.createElement("li", null, _react.default.createElement("span", {
    className: "emoji-bullet"
  }, "\uD83E\uDD14"), "is interested in game design, table top RPGs mostly, also board, card, and computer")));
};

var _default = About;
exports.default = _default;
},{"react":"node_modules/react/index.js","./Avatar":"src/js/Avatar.js"}],"src/js/timeline-data.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  items: [{
    ...
    fromDate: 'Apr, 2016',
    toDate: 'Nov, 2018',
    place: "Oxford Nanopore Technologies, Oxford, UK",
...
exports.default = _default;
},{}],"src/js/Timeline.js":[function(require,module,exports) {
"use strict";
...
var Projects = function Projects() {
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("h2", null, "Other work"), _react.default.createElement("p", null, "This is a collection of stuff that I have tinkered with or made over the years"), _react.default.createElement("ul", {
    className: "project-list"
  }, _react.default.createElement("li", null, "This site!"), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    to: "/gol"
  }, "Conway's game of life")), _react.default.createElement("li", null, _react.default.createElement("a", {
    href: "https://github.com/DavyK/pygame-examples/"
  }, "Maze building and path finding with python and pygame")), _react.default.createElement("li", null, _react.default.createElement("p", null, _react.default.createElement("a", {
    href: "https://pyweek.org/"
  }, "Pyweek"), " Entries:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, _react.default.createElement("a", {
    href: "https://pyweek.org/e/KA/"
  }, "Destination Irrelevant")), _react.default.createElement("li", null, _react.default.createElement("a", {
    href: "https://pyweek.org/e/KAP/"
  }, "Cultivate"))))));
};

var _default = Projects;
exports.default = _default;
},{"react":"node_modules/react/index.js","react-router-dom":"node_modules/react-router-dom/esm/react-router-dom.js"}],"src/js/GameOfLife/Controls.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(Controls, [{
    ...
    value: function render() {
      var _this$props = this.props,
          initialCount = _this$props.initialCount,
          changeInitialCountHandler = _this$props.changeInitialCountHandler,
          startHandler = _this$props.startHandler,
          stopHandler = _this$props.stopHandler,
          initializeHandler = _this$props.initializeHandler,
          size = _this$props.size,
          changeSizeHandler = _this$props.changeSizeHandler,
          interval = _this$props.interval,
          changeIntervalHandler = _this$props.changeIntervalHandler,
          resetHandler = _this$props.resetHandler,
          tickOnce = _this$props.tickOnce,
          started = _this$props.started;
      return _react.default.createElement("div", {
        className: "game-controls"
      }, _react.default.createElement("label", null, "Initial Count (", _react.default.createElement("span", null, initialCount), ")"), _react.default.createElement("input", {
        type: "range",
        value: initialCount,
        ...
        max: size * size,
        step: "5"
      }), _react.default.createElement("label", null, "Number of Rows & Columns (", _react.default.createElement("span", null, size), ")"), _react.default.createElement("input", {
        type: "range",
        value: size,
        ...
        max: "40",
        step: "1"
      }), _react.default.createElement("label", null, "Generation Interval (", _react.default.createElement("span", null, interval), ")"), _react.default.createElement("input", {
        type: "range",
        value: interval,
      ...
      }, "Initialise"), _react.default.createElement("button", {
        className: "cancel",
...
exports.default = _default;
},{"react":"node_modules/react/index.js"}],"src/js/GameOfLife/Cell.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(Cell, [{
    ...
    value: function render() {
      ...
      var transitionDuration = Math.min(0.4, parseFloat(interval) / 2 / 1000);
      return _react.default.createElement("span", {
        className: className,
        style: {
          transition: "background-color ".concat(transitionDuration, "s")
        },
        onClick: function onClick() {
          return _this.props.changeHandler(pos.x, pos.y);
        }
      });
    }
  }]);
...
var _default = Cell;
exports.default = _default;
},{"react":"node_modules/react/index.js"}],"src/js/GameOfLife/Grid.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(Grid, [{
    ...
    value: function isAlive(x, y) {
      var cellStr = "pos-".concat(x, "-").concat(y);
    ...
    value: function render() {
      ...
      var contents;
      var _this$props = this.props,
          nCols = _this$props.size,
          nRows = _this$props.size;
      var row;
      var cols;
      ...
      for (var y = 0; y < nRows; y++) {
        ...
        for (var x = 0; x < nCols; x++) {
          var activeClass = this.isAlive(x, y) ? ' alive' : '';
          cols.push(_react.default.createElement(_Cell.default, {
            className: "life-grid-cell".concat(activeClass),
            key: "cell-".concat(x, "-").concat(y),
            pos: {
              x: x,
              y: y
            },
        ...
        row = _react.default.createElement("div", {
          className: "life-grid-row",
          key: "row-".concat(y)
        }, cols);
        cells.push(row);
      }
...
var _default = Grid;
exports.default = _default;
},{"react":"node_modules/react/index.js","./Cell":"src/js/GameOfLife/Cell.js"}],"src/js/GameOfLife/index.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function GoL(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GoL).call(this, props));
    _this.state = DEFAULT_STATE;
    _this._timer = null;
    _this.toggleAlive = _this.toggleAlive.bind(_assertThisInitialized(_this));
    _this.startGame = _this.startGame.bind(_assertThisInitialized(_this));
    _this.makeRandomBoard = _this.makeRandomBoard.bind(_assertThisInitialized(_this));
    _this.changeInitialCountHandler = _this.changeInitialCountHandler.bind(_assertThisInitialized(_this));
    _this.initializeBoard = _this.initializeBoard.bind(_assertThisInitialized(_this));
    _this.stopGame = _this.stopGame.bind(_assertThisInitialized(_this));
    _this.changeSizeHandler = _this.changeSizeHandler.bind(_assertThisInitialized(_this));
    _this.reset = _this.reset.bind(_assertThisInitialized(_this));
    _this.tick = _this.tick.bind(_assertThisInitialized(_this));
    _this.changeIntervalHandler = _this.changeIntervalHandler.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(GoL, [{
    ...
    value: function getNeighbours(x, y) {
      var _this$state = this.state,
          nCols = _this$state.size,
          nRows = _this$state.size;
      var hMin = x - 1 < 0 ? nCols - 1 : x - 1;
      var hMax = x + 1 === nCols ? 0 : x + 1;
      var neighbourCols = [hMin, x, hMax];
      var vMin = y - 1 < 0 ? nRows - 1 : y - 1;
      var vMax = y + 1 === nRows ? 0 : y + 1;
      var neighbourRows = [vMin, y, vMax];
      var neighbours = new Set();

      for (var _i = 0, _neighbourCols = neighbourCols; _i < _neighbourCols.length; _i++) {
        var i = _neighbourCols[_i];

        for (var _i2 = 0, _neighbourRows = neighbourRows; _i2 < _neighbourRows.length; _i2++) {
          var j = _neighbourRows[_i2];

          if (!(i === x && j === y)) {
            neighbours.add("pos-".concat(i, "-").concat(j));
          }
        }
      }
    ...
    key: "makeRandomBoard",
    value: function makeRandomBoard(numCells) {
      var _this$state2 = this.state,
          nCols = _this$state2.size,
          nRows = _this$state2.size;
      var population = [];

      for (var y = 0; y < nRows; y++) {
        for (var x = 0; x < nRows; x++) {
          population.push("pos-".concat(x, "-").concat(y));
        }
      }

      function randomSample(sampleSet) {
        var idx = Math.floor(Math.random() * sampleSet.length);
    ...
    key: "changeSizeHandler",
    value: function changeSizeHandler(event) {
      this.setState({
    ...
    key: "toggleAlive",
    value: function toggleAlive(x, y) {
      var cellStr = "pos-".concat(x, "-").concat(y);
    ...
    key: "changeInitialCountHandler",
    value: function changeInitialCountHandler(event) {
      this.setState({
    ...
    key: "changeIntervalHandler",
    value: function changeIntervalHandler(event) {
      var _this3 = this;
    ...
    value: function tick() {
      var _this$state3 = this.state,
          alive = _this$state3.alive,
          generation = _this$state3.generation;
      var _this$state4 = this.state,
          nCols = _this$state4.size,
          nRows = _this$state4.size;
      var newAlive = new Set();

      for (var x = 0; x < nCols; x++) {
        for (var y = 0; y < nCols; y++) {
          var cellStr = "pos-".concat(x, "-").concat(y);
          var neighbours = this.getNeighbours(x, y);
          var numAliveNeighbours = intersection(alive, neighbours).size;
    ...
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h3", null, "Conway's Game of Life"), _react.default.createElement("div", {
        className: "text-data"
      }, "Generation: ", this.state.generation), _react.default.createElement(_Grid.default, {
...
var _default = GoL;
exports.default = _default;
},{"react":"node_modules/react/index.js","./Controls":"src/js/GameOfLife/Controls.js","./Grid":"src/js/GameOfLife/Grid.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"static/images/github.png":[function(require,module,exports) {
module.exports = "/github.633ce4c1.png";
},{}],"static/images/linkedin.png":[function(require,module,exports) {
module.exports = "/linkedin.bd79b1f3.png";
...
var _github = _interopRequireDefault(require("../../static/images/github.png"));

var _linkedin = _interopRequireDefault(require("../../static/images/linkedin.png"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Intro = function Intro() {
  return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Hello."), _react.default.createElement("section", null, _react.default.createElement("p", null, "I'm a software engineer, and I like building things."), _react.default.createElement("ul", {
    className: "nav-buttons list-unstyled"
  }, _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    className: "btn btn-outline-primary",
    to: "/about"
  }, "Read more about Davy")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    className: "btn btn-outline-primary",
    to: "/timeline"
  }, "Look at Davy's kinda C.V.")), _react.default.createElement("li", null, _react.default.createElement(_reactRouterDom.Link, {
    className: "btn btn-outline-primary",
    to: "/projects"
...
var NotFound = function NotFound() {
  return _react.default.createElement("div", null, _react.default.createElement("h2", null, "hmmm..."), _react.default.createElement("div", null, _react.default.createElement("iframe", {
    className: "video",
    width: "560",
    height: "315",
...
var AppRouter = function AppRouter() {
  return _react.default.createElement(_reactRouterDom.BrowserRouter, null, _react.default.createElement("header", null, _react.default.createElement("nav", null, _react.default.createElement("span", {
    ...
    path: "/gol",
    component: _GameOfLife.default
  }), _react.default.createElement(_reactRouterDom.Route, {
    component: NotFound
  }))));
};

_reactDom.default.render(_react.default.createElement(AppRouter, null), document.getElementById('root'));
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","react-router-dom":"node_modules/react-router-dom/esm/react-router-dom.js","./About":"src/js/About.js","./Timeline":"src/js/Timeline.js","./Projects":"src/js/Projects.js","./GameOfLife":"src/js/GameOfLife/index.js","../sass/index.scss":"src/sass/index.scss","../../static/images/github.png":"static/images/github.png","../../static/images/linkedin.png":"static/images/linkedin.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
